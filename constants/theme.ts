export const COLOURS = {
  ...
  bgRuling:       '#1b1940',   // warm violet tint (ruling card fill, rule tags, chip accents) #14122b
  bgAccent:       '#2d2a57',   // slightly lighter accent while keeping violet palette
