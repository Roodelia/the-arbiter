...
async function defaultSendTelegramAlert({ cards, situation, ruling }) {
...
/**
 * Builds the Express app. anthropic/voyage/supabase and the service-layer
 * functions are injected so tests can substitute fakes without touching
 * real network/API credentials.
 */
function createApp({
  anthropic,
  voyage,
